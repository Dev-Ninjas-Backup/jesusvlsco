...
class RatingFieldDialog extends StatelessWidget {
  final RatingFieldController controller = Get.find();

  RatingFieldDialog({super.key});
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Text(controller.ratingValue.value.toString(),
