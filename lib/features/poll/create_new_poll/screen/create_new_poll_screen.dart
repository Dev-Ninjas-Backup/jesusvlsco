...
// Title
              Obx(() => Text(controller.titleLabel)),
              const SizedBox(height: 12),
              CustomTextField(
                hintText: "Enter ${controller.pollType.value.toLowerCase()} title here",
                controller: controller.titleController,
              ),
              const SizedBox(height: 16),

// Description
              Obx(() => Text(controller.descriptionLabel)),
              const SizedBox(height: 12),
              CustomTextField(
                hintText: "Enter ${controller.pollType.value.toLowerCase()} description here",
              ...
              Column(
                children: List.generate(controller.questions.length, (index) {
                  ...
                  return QuestionCard(
                    ...
                    onRemoveQuestion: () => controller.removeQuestion(index),
                ...
                children: [
                  Expanded(
                    child: CustomButton(
                      ...
                      textColor: Color(0xFF4E53B1),
                      borderRadius: 8,
                      isExpanded: true, // ✅ new param
                    ),
                  ),
                  ...
                  Expanded(
                    child: CustomButton(
                      ...
                      decorationColor: Color(0xFF4E53B1),
