      ...
      child: Column(
        children: [
          ...
          _buildBadgeIconSection(),
              ...
              Padding(
                padding:EdgeInsets.only(left: Sizer.wp(16),right: Sizer.wp(16)),
                child: _buildTextFieldSection("Upload Custom Badge", icon: Icon(Icons.camera_alt_outlined, color: AppColors.text)),
              ),
              Padding(
                padding: EdgeInsets.only(left: Sizer.wp(16),right: Sizer.wp(16)),
              ...
              Padding(
                padding: EdgeInsets.only(bottom: Sizer.hp(16),left: Sizer.wp(16),right: Sizer.wp(16)),
